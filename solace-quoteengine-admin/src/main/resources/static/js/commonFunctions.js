...
const TXT_CONNECTING = "連接中...";
const TXT_CONNECT = "啟動行情接收";
const TXT_DISCONNECTING = "停止中...";
const TXT_DISCONNECT = "停止行情接收";
const TXT_REMIND_TO_SELECT = "請點選您想要看的股票名稱來獲取即時行情。"
...
function connectToBackend(){
    ...
    if (mySolaceClientUserName != null)
        strSolaceClientUserName = "customer-" + mySolaceClientUserName;
    ...
    subscriber.connect("my-solace.mooo.com", strSolaceVpnName, strSolaceClientUserName, "password");
